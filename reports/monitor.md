...
## 中期读数(2026-07-14,H1 实验 8000→8350)【出处:用户粘贴日志】

A2S 斜率 -0.104/500 步 ≈ 基线(-0.086/500)→ 趋向 **H1 不成立**(正式判决等 8500 满窗)。
enc/dec 比值 0.89~1.13 同量级 → **H2a(encoder 缺信号)被数据否定,H3 升为首选**。
勾稽 7/7 全过;稳定,止损未触发。待补:启动命令回显 + 8400-8500 行(见 EXPERIMENT_H1 §5)。
