...
# 触发戳 t2500 前的最后一个 '|' 字符属于 <|t1999|> —— 旧 rfind('|') 会切出 '...<' 垃圾
t = "|4/4k0PR:C4 <|t0|> 1/1 <|t1999|> |4/4k0c4D4 <|t2100|> 1/1 <|t2500|> |4/4k0d4"
...
check("cut_before_2100", "t2100" not in out and "t2500" not in out, out)

print("[2] 跨切点延音:开着的音在边界补 offset(Dyck 闭合)")
# C4 从第1小节持续到第3小节;截断发生在第2小节末 → C4 必须在切点闭合
t2 = ("|4/4k0PR:C4E4 <|t0|> 1/1e4 <|t190|> |4/4k0F4 <|t200|> 1/1f4 <|t390|> "
      "|4/4k0G4 <|t2400|> 1/1c4g4 <|t2790|> |4/4k0")
